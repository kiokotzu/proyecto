/* declaramos un router llamada Router con la funcionalidad de una router de Backbone */

Sfotipy.Router = Backbone.Router.extend({

	/* aqui especifimamos las rutas por defecto y la del album 
	   si la es distinta a album va a llamar una funcion index y 
	   si es album va a llamar una funcion album*/
  routes:{
  	"": "index",
  	"album/:name": "album"
  },
  ...
  fetchData: function () {
    ...
    // Load Data
    return $.getJSON('datos.json').then(function (data) {
      self.jsonData = data;
